...
def test_grid_add_new_tile_at_position():
    ...
    assert game_grid==[[' ',' ',' ', ' '],[' ', 2 ,' ', ' '],[' ',' ',' ', ' '],[' ',' ',' ', ' ']] or [[' ',' ',' ', ' '],[' ', 4,' ', ' '],[' ',' ',' ', ' '],[' ',' ',' ', ' ']]

def test_grid_add_new_tile_at_position_2():
    game_grid=create_grid(4)
    game_grid=grid_add_new_tile_at_position(game_grid,1,1)
...
def test_length():
    assert length([[0, 16, 32, 0], [64, 0, 32, 2], [2, 2, 8, 4], [512, 8, 16, 0]])== 4
    assert length([[0]])==1

def test_get_empty_tiles_positions():
    assert get_empty_tiles_positions([[0]])==[(0,0)]
